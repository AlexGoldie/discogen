...
Grow a lizard emoji from a single seed cell. The NCA learns local update rules that, when applied iteratively, produce the target pattern through emergent morphogenesis.
...
- **Target**: Lizard emoji (🦎) rendered as RGBA image
